...
badd +0 term://~/Research/ManifoldDestiny/script/R//155254:R\ 
...
setlocal fdn=20
setlocal nofen
let s:l = 21 - ((19 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 21
