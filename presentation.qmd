...
kableExtra::kbl(format(stfo_sel,digits=4)) %>% kableExtra::kable_classic_2(full_width = F) %>% kableExtra::row_spec(1, bold = F)
```
...
kableExtra::kbl(format(stfo_sel,digits=4)) %>% kableExtra::kable_paper(full_width = F) %>% kableExtra::row_spec(1, bold = F)
```
...
pr2n <- paste0(rprojroot::find_rstudio_root_file(),'/images/r2n.png')
knitr::include_graphics(c(pr2n))
```

 - Hybrid form
```{r, echo=F, out.width="40%", fig.cap=""}
pr2h <- paste0(rprojroot::find_rstudio_root_file(),'/images/r2h.png')
