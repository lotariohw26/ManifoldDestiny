...
kable(laws_df, format = "markdown", escape = FALSE) %>% kableExtra::kable_styling(font_size=16)
```
...
kable(combined, format = "markdown", escape = FALSE) %>% kableExtra::kable_styling(font_size=16)
```
...
[xxx application]({{< var shn3 >}})

---

# `r metad$toc$sec7$nmn`

[xxx application]({{< var shn4 >}})
