...
def genpolycoeff(expr=None, solvd='z', solvf='u0', eur=[0, 0, 0], plr=3):
    ...
    # With rotation
        ...
        if plr in [3]:
            ...
            C=[dic['d_310']*z**2+dic['d_311']*y*z+dic['d_312']*y**2+dic['d_110'],
               dic['d_301']*z**2+dic['d_311']*y*z+dic['d_321']*y**2+dic['d_101'],
        ...
        if plr in [2,3]:
            B=[dic['d_220'],
               dic['d_202'],
               dic['d_200']],
            C=[dic['d_210']*z+dic['d_211']*y,
               dic['d_201']*z+dic['d_211']*y,
               dic['d_201']*z+dic['d_210']*y]
            D=[dic['d_200']*z**2+dic['d_201']*y*z+dic['d_202']*y**2,
               dic['d_200']*z**2+dic['d_210']*y*z+dic['d_220']*y**2,
               dic['d_202']*z**2+dic['d_211']*y*z+dic['d_220']*y**2]
        if plr in [1,2,3]:
            C=[dic['d_110'],
               dic['d_101'],
               dic['d_110']
              ]
            D=[dic['d_100']*z+dic['d_101']*y+dic['d_000'],
               dic['d_100']*z+dic['d_110']*y+dic['d_000'],
               dic['d_101']*z+dic['d_110']*y+dic['d_000']]
        ABCDE[0] = str(A[nrs])
        ABCDE[1] = str(B[nrs])
        ABCDE[2] = str(C[nrs])
        ABCDE[3] = str(D[nrs])
