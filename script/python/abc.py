...
m2v = math.cos(math.radians(gra[0]))
m3v = math.cos(math.radians(gra[0]))
...
g_m=0
alpha_m=0
A = plsv.pareq(str(test[0][0]),a1=a1,a2=a2,a3=a3,b1=b1,b2=b2,b3=b3,c1=c1,c2=c2,c3=c3,k0=k0,k1=k1,k2=k2,k3=k3,k4=k4,k5=k5,k6=k6,k7=k7,k8=k8,k9=k0)
B = plsv.pareq(str(test[0][1]),a1=a1,a2=a2,a3=a3,b1=b1,b2=b2,b3=b3,c1=c1,c2=c2,c3=c3,k0=k0,k1=k1,k2=k2,k3=k3,k4=k4,k5=k5,k6=k6,k7=k7,k8=k8,k9=k0,h_m=h_m,g_m=g_m,alpha_m=alpha_m)
C = plsv.pareq(str(test[0][2]),a1=a1,a2=a2,a3=a3,b1=b1,b2=b2,b3=b3,c1=c1,c2=c2,c3=c3,k0=k0,k1=k1,k2=k2,k3=k3,k4=k4,k5=k5,k6=k6,k7=k7,k8=k8,k9=k0,h_m=h_m,g_m=g_m,alpha_m=alpha_m)
D = plsv.pareq(str(test[0][3]),a1=a1,a2=a2,a3=a3,b1=b1,b2=b2,b3=b3,c1=c1,c2=c2,c3=c3,k0=k0,k1=k1,k2=k2,k3=k3,k4=k4,k5=k5,k6=k6,k7=k7,k8=k8,k9=k0,h_m=h_m,g_m=g_m,alpha_m=alpha_m)
