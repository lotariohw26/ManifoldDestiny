...
sfo = ['g','h','alpha'][0]
pol1 = genpolycoeffr(elem=prv,expr=eqs,solv=sfo,eur=rve)
sfo = ['g','h','alpha'][1]
pol2 = genpolycoeffr(elem=prv,expr=eqs,solv=sfo,eur=rve)
sfo = ['g','h','alpha'][2]
pol3 = genpolycoeffr(elem=prv,expr=eqs,solv=sfo,eur=rve)
...
a2 = pareq(ste=str(pol1[1][1]),m1=m1v,m2=m2v,m3=m3v,n1=n1v,n2=n2v,n3=n3v)
a3 = pareq(ste=str(pol1[1][2]),m1=m1v,m2=m2v,m3=m3v,n1=n1v,n2=n2v,n3=n3v)
b1 = pareq(ste=str(pol1[1][3]),m1=m1v,m2=m2v,m3=m3v,n1=n1v,n2=n2v,n3=n3v)
b2 = pareq(ste=str(pol1[1][4]),m1=m1v,m2=m2v,m3=m3v,n1=n1v,n2=n2v,n3=n3v)
b3 = pareq(ste=str(pol1[1][5]),m1=m1v,m2=m2v,m3=m3v,n1=n1v,n2=n2v,n3=n3v)
c1 = pareq(ste=str(pol1[1][6]),m1=m1v,m2=m2v,m3=m3v,n1=n1v,n2=n2v,n3=n3v)
c2 = pareq(ste=str(pol1[1][7]),m1=m1v,m2=m2v,m3=m3v,n1=n1v,n2=n2v,n3=n3v)
c3 = pareq(ste=str(pol1[1][8]),m1=m1v,m2=m2v,m3=m3v,n1=n1v,n2=n2v,n3=n3v)
...
C1=pareq(ste=str(pol1[0][2]),a1=a1, a2=a2, a3=a3, b1=b1, b2=b2, b3=b3, c1=c1, c2=c2, c3=c3, k0=k0, k1=k1, k2=k2, k3=k3, k4=k4, k5=k5, k6=k6, k7=k7, k8=k8, k9=k9,alpha_m=0,g_m=0,h_m=0)
D1=pareq(ste=str(pol1[0][3]),a1=a1, a2=a2, a3=a3, b1=b1, b2=b2, b3=b3, c1=c1, c2=c2, c3=c3, k0=k0, k1=k1, k2=k2, k3=k3, k4=k4, k5=k5, k6=k6, k7=k7, k8=k8, k9=k9,alpha_m=0,g_m=0,h_m=0)
#
A2=pareq(ste=str(pol2[0][0]),a1=a1, a2=a2, a3=a3, b1=b1, b2=b2, b3=b3, c1=c1, c2=c2, c3=c3, k0=k0, k1=k1, k2=k2, k3=k3, k4=k4, k5=k5, k6=k6, k7=k7, k8=k8, k9=k9,alpha_m=0,g_m=0,h_m=0)
B2=pareq(ste=str(pol2[0][1]),a1=a1, a2=a2, a3=a3, b1=b1, b2=b2, b3=b3, c1=c1, c2=c2, c3=c3, k0=k0, k1=k1, k2=k2, k3=k3, k4=k4, k5=k5, k6=k6, k7=k7, k8=k8, k9=k9,alpha_m=0,g_m=0,h_m=0)
C2=pareq(ste=str(pol2[0][2]),a1=a1, a2=a2, a3=a3, b1=b1, b2=b2, b3=b3, c1=c1, c2=c2, c3=c3, k0=k0, k1=k1, k2=k2, k3=k3, k4=k4, k5=k5, k6=k6, k7=k7, k8=k8, k9=k9,alpha_m=0,g_m=0,h_m=0)
D2=pareq(ste=str(pol2[0][3]),a1=a1, a2=a2, a3=a3, b1=b1, b2=b2, b3=b3, c1=c1, c2=c2, c3=c3, k0=k0, k1=k1, k2=k2, k3=k3, k4=k4, k5=k5, k6=k6, k7=k7, k8=k8, k9=k9,alpha_m=0,g_m=0,h_m=0)
#
A3=pareq(ste=str(pol3[0][0]),a1=a1, a2=a2, a3=a3, b1=b1, b2=b2, b3=b3, c1=c1, c2=c2, c3=c3, k0=k0, k1=k1, k2=k2, k3=k3, k4=k4, k5=k5, k6=k6, k7=k7, k8=k8, k9=k9,alpha_m=0,g_m=0,h_m=0)
