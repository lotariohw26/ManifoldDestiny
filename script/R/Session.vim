...
badd +27 ~/Research/ManifoldDestiny/_quarto.yml
...
badd +13 ~/Research/ManifoldDestiny/script/R/testing.R
badd +28 term://~/Research/ManifoldDestiny/script/python//155604:bash
badd +49 ~/Research/ManifoldDestiny/prerendr.R
...
badd +1 ~/Research/ManifoldDestiny/presentation.qmd
badd +1 term://~/Research/ManifoldDestiny/data-raw//385230:R\ 
...
exe 'vert 1resize ' . ((&columns * 94 + 139) / 279)
exe '2resize ' . ((&lines * 24 + 34) / 68)
exe 'vert 2resize ' . ((&columns * 94 + 139) / 279)
exe '3resize ' . ((&lines * 9 + 34) / 68)
exe 'vert 3resize ' . ((&columns * 94 + 139) / 279)
exe '4resize ' . ((&lines * 8 + 34) / 68)
exe 'vert 4resize ' . ((&columns * 94 + 139) / 279)
exe '5resize ' . ((&lines * 21 + 34) / 68)
exe 'vert 5resize ' . ((&columns * 91 + 139) / 279)
exe '6resize ' . ((&lines * 21 + 34) / 68)
exe 'vert 6resize ' . ((&columns * 91 + 139) / 279)
exe '7resize ' . ((&lines * 21 + 34) / 68)
exe 'vert 7resize ' . ((&columns * 91 + 139) / 279)
exe 'vert 8resize ' . ((&columns * 92 + 139) / 279)
argglobal
...
setlocal fdn=20
setlocal nofen
let s:l = 60 - ((1 * winheight(0) + 10) / 21)
...
setlocal fdn=20
setlocal nofen
let s:l = 14 - ((7 * winheight(0) + 12) / 24)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 14
...
wincmd w
argglobal
if bufexists(fnamemodify("term://~/Research/ManifoldDestiny/data-raw//385230:R\ ", ":p")) | buffer term://~/Research/ManifoldDestiny/data-raw//385230:R\  | else | edit term://~/Research/ManifoldDestiny/data-raw//385230:R\  | endif
if &buftype ==# 'terminal'
  silent file term://~/Research/ManifoldDestiny/data-raw//385230:R\ 
endif
...
setlocal fdn=20
setlocal nofen
let s:l = 723 - ((5 * winheight(0) + 10) / 21)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 723
...
setlocal fdn=20
setlocal nofen
let s:l = 17 - ((9 * winheight(0) + 32) / 65)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 17
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 99 + 139) / 279)
exe 'vert 2resize ' . ((&columns * 179 + 139) / 279)
argglobal
balt ~/Research/ManifoldDestiny/_quarto.yml
setlocal fdm=expr
setlocal fde=nvim_treesitter#foldexpr()
...
setlocal fdn=20
setlocal nofen
let s:l = 283 - ((41 * winheight(0) + 32) / 65)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 283
...
exe 'vert 2resize ' . ((&columns * 179 + 139) / 279)
tabnext
edit ~/Research/ManifoldDestiny/prerendr.R
let s:save_splitbelow = &splitbelow
let s:save_splitright = &splitright
set splitbelow splitright
wincmd _ | wincmd |
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 198 + 139) / 279)
exe 'vert 2resize ' . ((&columns * 80 + 139) / 279)
argglobal
balt ~/Research/ManifoldDestiny/_quarto.yml
setlocal fdm=expr
setlocal fde=nvim_treesitter#foldexpr()
...
setlocal fdn=20
setlocal nofen
let s:l = 272 - ((64 * winheight(0) + 32) / 65)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 272
...
wincmd w
argglobal
if bufexists(fnamemodify("term://~/Research/ManifoldDestiny//1335872:R\ ", ":p")) | buffer term://~/Research/ManifoldDestiny//1335872:R\  | else | edit term://~/Research/ManifoldDestiny//1335872:R\  | endif
if &buftype ==# 'terminal'
  silent file term://~/Research/ManifoldDestiny//1335872:R\ 
endif
balt ~/Research/ManifoldDestiny/prerendr.R
setlocal fdm=expr
setlocal fde=nvim_treesitter#foldexpr()
setlocal fmr={{{,}}}
setlocal fdi=#
...
setlocal fdn=20
setlocal nofen
let s:l = 209 - ((64 * winheight(0) + 32) / 65)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 209
