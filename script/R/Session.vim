...
setlocal fdn=20
setlocal nofen
let s:l = 272 - ((18 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 272
...
setlocal fdn=20
setlocal nofen
let s:l = 298 - ((12 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 298
...
wincmd w
argglobal
if bufexists(fnamemodify("term://~/Research/ManifoldDestiny/script/R//1839319:R\ ", ":p")) | buffer term://~/Research/ManifoldDestiny/script/R//1839319:R\  | else | edit term://~/Research/ManifoldDestiny/script/R//1839319:R\  | endif
if &buftype ==# 'terminal'
  silent file term://~/Research/ManifoldDestiny/script/R//1839319:R\ 
endif
setlocal fdm=expr
setlocal fde=nvim_treesitter#foldexpr()
setlocal fmr={{{,}}}
...
setlocal fdn=20
setlocal nofen
let s:l = 432 - ((14 * winheight(0) + 7) / 15)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 432
...
setlocal fdn=20
setlocal nofen
let s:l = 721 - ((6 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 721
