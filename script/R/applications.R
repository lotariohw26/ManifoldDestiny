...
app1_rp <- selreport(app0,md$app0)
app_1_out <- seloutput(app0_rp)
app2_rp <- selreport(app0,md$app0)
app_2_out <- seloutput(app0_rp)
app3_rp <- selreport(app0,md$app0)
app_3_out <- seloutput(app0_rp)
app4_rp <- selreport(app0,md$app0)
app_4_out <- seloutput(app0_rp)
