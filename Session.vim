...
badd +21 ~/InitLOT/README.md
badd +1 ~/InitLOT/Session.vim
badd +2 ~/Research/ManifoldDestiny/_quarto.yml
badd +1 ~/InitLOT/config/nvim/init.vim
badd +60 ~/InitLOT/config/nvim/keymapping.vim
badd +1 ~/InitLOT/config/nvim/Session.vim
argglobal
%argdel
...
exe 'vert 3resize ' . ((&columns * 68 + 104) / 208)
argglobal
balt ~/InitLOT/README.md
setlocal fdm=expr
