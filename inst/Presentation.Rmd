...
## Natural election in state 1

## Rigged election in state 2
...
```{r, echo=FALSE,message=F,out.width="75%",out.height="70%",fig.cap="",fig.show='hold',fig.align='center'}
