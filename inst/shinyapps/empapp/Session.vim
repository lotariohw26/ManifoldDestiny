...
badd +8 ~/Research/ManifoldDestiny/_quarto.yml
...
badd +0 term://~/Research/ManifoldDestiny/script/R//236934:R\ 
argglobal
%argdel
...
setlocal fdn=20
setlocal nofen
let s:l = 52 - ((19 * winheight(0) + 10) / 21)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 52
...
setlocal fdn=20
setlocal nofen
let s:l = 147 - ((63 * winheight(0) + 32) / 65)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 147
